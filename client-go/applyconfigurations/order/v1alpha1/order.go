...
type OrderApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	Spec                             *orderv1alpha1.OrderSpec   `json:"spec,omitempty"`
	Status                           *orderv1alpha1.OrderStatus `json:"status,omitempty"`
}
...
func (b *OrderApplyConfiguration) WithSpec(value orderv1alpha1.OrderSpec) *OrderApplyConfiguration {
	b.Spec = &value
	return b
}
...
func (b *OrderApplyConfiguration) WithStatus(value orderv1alpha1.OrderStatus) *OrderApplyConfiguration {
	b.Status = &value
	return b
}
