...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v1alpha1.ArtifactWorkflowTTLSettings{}.OpenAPIModelName(): schema_arc_api_arc_v1alpha1_ArtifactWorkflowTTLSettings(ref),
		...
		v1alpha1.Cron{}.OpenAPIModelName():                        schema_arc_api_arc_v1alpha1_Cron(ref),
...
func schema_arc_api_arc_v1alpha1_ArtifactType(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactTypeSpec{}.OpenAPIModelName(), v1alpha1.ArtifactTypeStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_ArtifactTypeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactType{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"srcTypes": {
						SchemaProps: spec.SchemaProps{
							Description: "SrcTypes is a list of Endpoint types, that are supported as source.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_arc_api_arc_v1alpha1_ArtifactWorkflow(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.ArtifactWorkflowSpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.ArtifactWorkflowStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.ArtifactWorkflowSpec{}.OpenAPIModelName(), v1alpha1.ArtifactWorkflowStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_arc_api_arc_v1alpha1_ArtifactWorkflowList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ArtifactWorkflowList is a list of ArtifactWorkflow objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.ArtifactWorkflow{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.ArtifactWorkflow{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_ArtifactWorkflowSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactTypeTemplateRef{}.OpenAPIModelName(), v1alpha1.ArtifactWorkflowParameter{}.OpenAPIModelName(), v1alpha1.Cron{}.OpenAPIModelName(), v1.LocalObjectReference{}.OpenAPIModelName(), metav1.Duration{}.OpenAPIModelName()},
	}
}

func schema_arc_api_arc_v1alpha1_ArtifactWorkflowStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"failureTime": {
						SchemaProps: spec.SchemaProps{
							Description: "FailureTime is the time when the workflow finished with a failure status.",
							Ref:         ref(metav1.Time{}.OpenAPIModelName()),
						},
					},
					"lastScheduled": {
					...
					"activeWorkflowRef": {
						SchemaProps: spec.SchemaProps{
							Description: "ActiveWorkflowRef tracks the currently spawned workflow, if cron is used. It resets after a successful or failed run.",
							Default:     map[string]interface{}{},
							Ref:         ref(v1.LocalObjectReference{}.OpenAPIModelName()),
						},
					},
				},
				Required: []string{"activeWorkflowRef"},
			},
		},
		Dependencies: []string{
			v1.LocalObjectReference{}.OpenAPIModelName(), metav1.Time{}.OpenAPIModelName()},
	}
}

func schema_arc_api_arc_v1alpha1_ArtifactWorkflowTTLSettings(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_arc_api_arc_v1alpha1_ClusterArtifactTypeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ClusterArtifactType{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_arc_api_arc_v1alpha1_Cron(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Cron represents an order's cron schedule.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"timezone": {
						SchemaProps: spec.SchemaProps{
...
func schema_arc_api_arc_v1alpha1_Endpoint(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.EndpointSpec{}.OpenAPIModelName(), v1alpha1.EndpointStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_EndpointList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.Endpoint{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_EndpointSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "EndpointSpec specifies a single artifact which is translated into a corresponding Workflow based on its type.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
					...
					"remoteURL": {
						SchemaProps: spec.SchemaProps{
							Description: "RemoteURL defines the URL which is used to interact with the endpoint.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"usage": {
						SchemaProps: spec.SchemaProps{
							...
							Type:        []string{"string"},
							Format:      "",
							Enum:        []interface{}{"All", "PullOnly", "PushOnly"},
						},
					},
				},
...
func schema_arc_api_arc_v1alpha1_Order(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.OrderSpec{}.OpenAPIModelName(), v1alpha1.OrderStatus{}.OpenAPIModelName(), metav1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_OrderArtifact(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.Cron{}.OpenAPIModelName(), v1.LocalObjectReference{}.OpenAPIModelName(), runtime.RawExtension{}.OpenAPIModelName()},
	}
}

func schema_arc_api_arc_v1alpha1_OrderArtifactWorkflowStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_arc_api_arc_v1alpha1_OrderDefaults(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.Cron{}.OpenAPIModelName(), v1.LocalObjectReference{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_OrderList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrderList is a list of Order objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			v1alpha1.Order{}.OpenAPIModelName(), metav1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_arc_api_arc_v1alpha1_OrderStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
						...
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.OrderArtifactWorkflowStatus{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.OrderArtifactWorkflowStatus{}.OpenAPIModelName(), metav1.Time{}.OpenAPIModelName()},
	}
}
