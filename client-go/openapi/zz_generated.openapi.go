...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		v1alpha1.ClusterEndpoint{}.OpenAPIModelName():                    schema_arc_api_arc_v1alpha1_ClusterEndpoint(ref),
		v1alpha1.ClusterEndpointList{}.OpenAPIModelName():                schema_arc_api_arc_v1alpha1_ClusterEndpointList(ref),
...
func schema_arc_api_arc_v1alpha1_ArtifactWorkflow(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactWorkflowSpec{}.OpenAPIModelName(), v1alpha1.ArtifactWorkflowStatus{}.OpenAPIModelName(), "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_arc_api_arc_v1alpha1_ArtifactWorkflowList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactWorkflow{}.OpenAPIModelName(), "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_arc_api_arc_v1alpha1_ArtifactWorkflowSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.ArtifactTypeTemplateRef{}.OpenAPIModelName(), v1alpha1.ArtifactWorkflowParameter{}.OpenAPIModelName(), v1alpha1.Cron{}.OpenAPIModelName(), "k8s.io/api/core/v1.LocalObjectReference"},
	}
}
...
func schema_arc_api_arc_v1alpha1_ClusterEndpoint(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterEndpoint is the Schema for the endpoints API",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_arc_api_arc_v1alpha1_ClusterEndpointList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterEndpointList is a list of Endpoint objects.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref(v1alpha1.ClusterEndpoint{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.ClusterEndpoint{}.OpenAPIModelName(), "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_arc_api_arc_v1alpha1_OrderArtifact(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.Cron{}.OpenAPIModelName(), "k8s.io/api/core/v1.LocalObjectReference", "k8s.io/apimachinery/pkg/runtime.RawExtension"},
	}
}
