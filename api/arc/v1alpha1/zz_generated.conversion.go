...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*OrderCron)(nil), (*arc.OrderCron)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_OrderCron_To_arc_OrderCron(a.(*OrderCron), b.(*arc.OrderCron), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*arc.OrderCron)(nil), (*OrderCron)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_arc_OrderCron_To_v1alpha1_OrderCron(a.(*arc.OrderCron), b.(*OrderCron), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_OrderArtifact_To_arc_OrderArtifact(in *OrderArtifact, out *arc.OrderArtifact, s conversion.Scope) error {
	...
	out.Spec = in.Spec
	if err := Convert_v1alpha1_OrderCron_To_arc_OrderCron(&in.Cron, &out.Cron, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_arc_OrderArtifact_To_v1alpha1_OrderArtifact(in *arc.OrderArtifact, out *OrderArtifact, s conversion.Scope) error {
	...
	out.DstRef = in.DstRef
	out.Spec = in.Spec
	if err := Convert_arc_OrderCron_To_v1alpha1_OrderCron(&in.Cron, &out.Cron, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1alpha1_OrderCron_To_arc_OrderCron(in *OrderCron, out *arc.OrderCron, s conversion.Scope) error {
...
// Convert_v1alpha1_OrderCron_To_arc_OrderCron is an autogenerated conversion function.
func Convert_v1alpha1_OrderCron_To_arc_OrderCron(in *OrderCron, out *arc.OrderCron, s conversion.Scope) error {
	return autoConvert_v1alpha1_OrderCron_To_arc_OrderCron(in, out, s)
}

func autoConvert_arc_OrderCron_To_v1alpha1_OrderCron(in *arc.OrderCron, out *OrderCron, s conversion.Scope) error {
	out.Timezone = in.Timezone
...
// Convert_arc_OrderCron_To_v1alpha1_OrderCron is an autogenerated conversion function.
func Convert_arc_OrderCron_To_v1alpha1_OrderCron(in *arc.OrderCron, out *OrderCron, s conversion.Scope) error {
	return autoConvert_arc_OrderCron_To_v1alpha1_OrderCron(in, out, s)
}
